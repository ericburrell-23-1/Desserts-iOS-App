...
#ifndef DESSERTSTESTS_SWIFT_H
#define DESSERTSTESTS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DessertsTests",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, strong) XCTestExpectation * _Null_unspecified expectation;
@property (nonatomic, copy) NSString * _Nonnull apiURLString;
@property (nonatomic, copy) NSString * _Nonnull strMeal;
@property (nonatomic, copy) NSString * _Nonnull strMealThumb;
@property (nonatomic, copy) NSString * _Nonnull idMeal;
@property (nonatomic) NSInteger urlStatusCode;
- (BOOL)setUpWithError:(NSError * _Nullable * _Nullable)error;
- (BOOL)tearDownWithError:(NSError * _Nullable * _Nullable)error;
...
SWIFT_CLASS("_TtC13DessertsTests15MockURLProtocol")
